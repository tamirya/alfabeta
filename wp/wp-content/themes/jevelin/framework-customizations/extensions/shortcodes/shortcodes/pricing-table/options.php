	...
	'general' => array(
		...
		'options' => array(
			...
			'content' => array(
			    ...
			    'box-options' => array(
			        'amount' => array( 'label' => esc_html__('Amount', 'jevelin'), 'type' => 'text' ),
			        'description' => array( 'label' => esc_html__('Description', 'jevelin'), 'type' => 'text' ),
			        'icon' => array( 'label' => esc_html__('Icon', 'jevelin'), 'type' => 'new-icon', 'set' => 'jevelin-icons', ),
			    ),
