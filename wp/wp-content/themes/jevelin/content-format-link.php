			...
			<div class="post-with-background">
				...
				<div class="post-quote-and-link">
					...
					<span class="post-quote-and-link-details">
						<?php echo jevelin_post_option( get_the_ID(), 'post-url' ); ?>
					</span>
				</div>
				...
				<div class="ratio-content">
					<div class="post-with-background sh-table">
						<div class="sh-table-cell">
							...
							<a class="mini-post-description" href="<?php echo esc_url( jevelin_post_option( get_the_ID(), 'post-url' ) ); ?>" target="_blank">
				...
				<div class="col-md-6 post-column-right">
					...
					<div class="post-content-container">
						<div>
							...
							<?php if( jevelin_post_option( get_the_ID(), 'post-url' ) ) : ?>
								<div class="post-content">
									<?php echo jevelin_post_option( get_the_ID(), 'post-url' ); ?>
								</div>
							<?php endif; ?>
